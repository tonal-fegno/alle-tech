...
export default function ProductsSliderCarousel({ products }: { products: Product[] }) {
            ...
            {products.map((item, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `${SOLUTION_ART[i % SOLUTION_ART.length].blobA}, ${SOLUTION_ART[i % SOLUTION_ART.length].blobB}, ${SOLUTION_ART[i % SOLUTION_ART.length].base}`,
                  }}
                />
                {/* Legibility scrim */}
