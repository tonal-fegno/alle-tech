...
export function CaseStudyForm({
  ...
  return (
    <Form {...form}>
      <form id="case-study-form" onSubmit={form.handleSubmit(onSubmit)}>
        <FormShell
          title={caseStudyId ? `Edit case study${defaultValues?.title ? `: ${defaultValues.title}` : ""}` : "New case study"}
          backHref="/dashboard/case-studies"
          formId="case-study-form"
          sections={SECTIONS}
          isSubmitting={form.formState.isSubmitting}
          submitLabel={caseStudyId ? "Save changes" : "Create case study"}
        >
          <FormSection id="details" title="Details" description="Listing card info and metadata." icon={Info}>
            ...
            <FormField control={form.control} name="image" render={({ field }) => (
              <FormItem><FormLabel>Image</FormLabel><FormControl><ImageUpload className="max-w-sm" prefix="case-studies" value={field.value} onChange={field.onChange} /></FormControl><FormMessage /></FormItem>
            )} />
          </FormSection>

          <FormSection id="results" title="Headline results" icon={TrendingUp}>
          ...
          <FormSection id="body" title="Body" icon={FileText}>
