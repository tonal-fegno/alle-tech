export const SOLUTIONS_SEED = [
  {
    ...
    "shortDescription": "Streamline your business with an integrated ERP solution that simplifies operations, improves visibility, and drives growth.",
    ...
    "relatedIndustriesTitle": "Industry Solutions",
    "relatedIndustries": [
      {
        "name": "Manufacturing",
    ...
    "faqs": [
      {
        ...
        "answer": "Depending on scope, customizations, and modules used, a standard implementation typically takes 12 to 24 weeks. This includes detailed discovery, data cleansing, configurations, custom layout building, training, and parallel testing phases."
      },
      {
        "question": "Can we migrate historical data from QuickBooks or legacy files?",
        "answer": "Yes. ALLE TECH specializes in database transitions. We assist you in extracting, cleansing, and importing master data records (customers, suppliers, items) and open financial entries securely into SAP Business One."
      },
      {
        "question": "Is SAP Business One available in the cloud or on-premise?",
        "answer": "SAP Business One supports both configurations. You can host it in the cloud (managed secure hosting on AWS or Azure) for easy remote access with low upfront infrastructure cost, or deploy it on-premise on local enterprise servers."
      },
      {
        "question": "What are the licensing models (subscription vs. perpetual)?",
        "answer": "We offer two models: Subscription licenses (monthly operating expenditure covering hosting, license, and basic maintenance) and Perpetual licenses (one-time capital purchase with an annual maintenance program for software updates)."
      },
      {
        "question": "How does ALLE TECH handle custom integrations and add-ons?",
        "answer": "We use the standard SAP Business One Integration Framework (B1iF) and SDK/API protocols. This guarantees that all custom connections (e.g. to CRM, custom portals, banking) remain fully functional and upgrade-safe."
      }
    ],
  ...
  },
  {
    "slug": "odoo-erp",
    "title": "Odoo ERP",
    "shortDescription": "Simplify and automate your business processes with a flexible ERP platform that connects every department in one system.",
    ...
    "heroTitle": "Odoo ERP",
    "heroSubtitle": "Transform Operations With a Flexible, All-in-One ERP Platform",
    "heroImage": "/images/solutions/details/odoo_erp.png",
    "whyTitle": "Why Odoo?",
    "whyItems": [
      {
    ...
    "relatedIndustriesTitle": "Supported Industries",
    "relatedIndustries": [
      {
        "name": "eCommerce & POS",
    ...
    "faqs": [
      {
        ...
        "answer": "Odoo Community is open-source and free, covering basic accounting and inventory. Odoo Enterprise requires active user license subscriptions and unlocks advanced features like full accounting, barcode support, mobile apps, and direct upgrade services."
      },
      {
        "question": "Is Odoo scalable?",
        "answer": "Highly scalable. Odoo is run by thousands of small businesses as well as large enterprise corporations with over 300,000 daily transactions."
      }
    ],
  ...
  },
  {
    ...
    "shortDescription": "Accelerate business growth with expert technology consulting, digital innovation, and tailored transformation strategies.",
    "image": "/images/our-solutions/Technology%20Consulting%20%26%20Digital%20Transformation.png",
    "tags": [
      "Digital Strategy",
      "Process Automation",
      "IT Modernization"
    ...
    "heroImage": "/images/solutions/details/technology_consulting.png",
    ...
    "relatedIndustriesTitle": null,
    "relatedIndustries": [],
    "integrationsTitle": null,
    "integrations": [],
    "faqsTitle": "Consulting FAQs",
    "faqs": [
      {
        "question": "How does the ERP selection process work?",
        "answer": "We map your operational requirements, compile an RFP, evaluate vendor responses, arrange structured demos, and help negotiate license contracts objectively."
      },
      {
        "question": "What does an AI readiness check involve?",
        "answer": "We review database cleanliness, file consistency, API accessibility, and process rules to see if your data supports AI automation models."
      }
    ],
    "outcomesTitle": "Business Outcomes That Matter",
    "outcomes": [
  ...
  },
  {
    ...
    "shortDescription": "Transform your data into actionable insights with interactive dashboards, real-time analytics, and intelligent reporting.",
    "image": "/images/our-solutions/Business%20Intelligence%20%26%20Power%20BI.png",
    "tags": [
    ...
    "heroSubtitle": "Turn Scattered Operational Data into Actionable Real-Time Insights",
    "heroImage": "/images/solutions/details/business_intelligence.png",
    ...
    "relatedIndustriesTitle": "Industries We Support",
    "relatedIndustries": [
      {
        "name": "Manufacturing",
    ...
    "faqs": [
      {
        ...
        "answer": "Power BI is a Microsoft analytics platform that transforms raw data from multiple sources into interactive dashboards and reports. It gives executives real-time visibility into sales, margins, inventory, and financial health without waiting for manual monthly reports."
      },
      {
        "question": "Can Power BI connect to our existing ERP system?",
        "answer": "Yes. Power BI integrates directly with SAP Business One, Odoo, SQL databases, Excel files, and cloud services. We build secure data gateways and pre-configured connectors so your dashboards refresh automatically."
      },
      {
        "question": "How long does a Power BI deployment take?",
        "answer": "A typical deployment takes 3 to 6 weeks. This includes source identification, data modeling, DAX metric writing, dashboard design, user training, and gateway setup for live data refresh."
      },
      {
        "question": "Do we need to replace our current reporting tools?",
        "answer": "No. Power BI complements existing tools. Many clients continue using SAP Crystal Reports or Excel for operational tasks while adding Power BI for executive-level analytics and cross-department visibility."
      }
    ],
    "outcomesTitle": "Business Outcomes That Matter",
    "outcomes": [
  ...
  },
  {
    ...
    "shortDescription": "Seamlessly connect your business systems to streamline workflows, improve data accuracy, and enable real-time collaboration.",
    "image": "/images/our-solutions/ERP%20Integration%20%26%20Enterprise%20Connectivity.png",
    "tags": [
      "System Integration",
      "API Connectivity",
    ...
    "heroSubtitle": "Eliminate Manual Data Entry by Connecting Your Business Ecosystem",
    "heroImage": "/images/solutions/details/erp_integration.png",
    ...
    "faqs": [
      {
        ...
        "answer": "We integrate CRMs (Salesforce, HubSpot), eCommerce platforms (Shopify, Magento), banking portals, shipping APIs (DHL, FedEx), payment gateways (Stripe, PayPal), and custom in-house applications using REST, SOAP, or webhook protocols."
      },
      {
        "question": "How do you ensure data stays synchronized across systems?",
        "answer": "We build bidirectional sync pipelines with conflict resolution rules, retry logic, and real-time event triggers. Every transaction is logged and auditable, ensuring zero data loss between connected platforms."
      },
      {
        "question": "Will integrations break when we upgrade our ERP?",
        "answer": "No. We use standard API service layers and middleware abstraction, so custom integrations remain functional across ERP version upgrades. We also provide post-upgrade verification testing."
      },
      {
        "question": "Can you integrate legacy on-premise systems with cloud ERPs?",
        "answer": "Yes. We deploy secure VPN tunnels, hybrid API gateways, and ETL batch pipelines to bridge legacy on-premise databases with modern cloud ERP environments."
      }
    ],
    "outcomesTitle": "Business Outcomes That Matter",
    "outcomes": [
  ...
  },
  {
    ...
    "shortDescription": "Build a secure, scalable, and reliable IT environment with modern cloud solutions and infrastructure management.",
    "image": "/images/our-solutions/Cloud%20%26%20IT%20Infrastructure%20Services.png",
    "tags": [
      "Cloud Migration",
    ...
    "heroSubtitle": "Build a Secure, Connected, and Future-Ready Technology Infrastructure",
    ...
    "faqs": [
      {
        ...
        "answer": "It depends on your security requirements, budget, and team access needs. We assess your infrastructure and recommend the optimal mix — many midmarket companies benefit from hybrid cloud setups that balance cost with data control."
      },
      {
        "question": "What cloud providers do you work with?",
        "answer": "We deploy on Microsoft Azure, Amazon Web Services (AWS), and Google Cloud Platform (GCP). Provider selection is based on your existing ecosystem, ERP requirements, and compliance standards."
      },
      {
        "question": "How do you handle disaster recovery?",
        "answer": "We configure automated daily backups, cross-region replication, and failover clusters. Recovery Point Objectives (RPO) and Recovery Time Objectives (RTO) are agreed upon during the discovery phase and tested quarterly."
      },
      {
        "question": "What is your uptime guarantee?",
        "answer": "We target 99.9% uptime for production environments through redundant load balancers, auto-scaling groups, and proactive server health monitoring with 24/7 alerting."
      }
    ],
    "outcomesTitle": "Business Outcomes That Matter",
    "outcomes": [
  ...
  },
  {
    ...
    "shortDescription": "Keep your business running smoothly with proactive IT management, continuous monitoring, and expert technical support.",
    "image": "/images/our-solutions/Managed%20Services%20%26%20Technology%20Support.png",
    "tags": [
      "24/7 Monitoring",
      "Help Desk Support",
      "System Maintenance"
    ...
    "heroSubtitle": "Proactive Support. Continuous Improvement. Long-Term Partnership.",
    "heroImage": "/images/solutions/details/managed_services.png",
    ...
    "faqs": [
      {
        ...
        "answer": "No. We also support organizations with existing SAP Business One, Odoo, Power BI, integrations, and other business technology environments, even if they were implemented by another partner."
      },
      {
        "question": "Can you provide remote and on-site support?",
        "answer": "Yes. We offer both remote and on-site support based on your service agreement and business requirements."
      },
      {
        "question": "Do you offer Service Level Agreements (SLAs)?",
        "answer": "Yes. We provide flexible support agreements with defined response times, service levels, and ongoing account management to match your operational needs."
      },
      {
        "question": "Can Managed Services include continuous enhancements?",
        "answer": "Absolutely. Our managed services can include process improvements, custom developments, new reports, dashboards, integrations, training, and optimization initiatives."
      }
    ],
    "outcomesTitle": "Business Outcomes That Matter",
    "outcomes": [
    ...
    "ctaSubtitle": "Technology is not a one-time project. It is an ongoing journey of improvement, innovation, and growth. Let's maximize the value of your technology investment together.",
