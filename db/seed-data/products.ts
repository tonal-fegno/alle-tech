export const PRODUCTS_SEED = [
  {
    ...
    "cardFeatures": ["SFA Mobility", "Merchandising", "Offline Engine", "Route Planner"],
    "conceptBullets": [
    ...
    "heroImage": "/images/products/repprox.png",
    "accentColor": "from-blue-600 to-indigo-700",
    "accentGradient": "linear-gradient(to right, #2563eb, #4338ca)",
    "heroDesc": "RepProX connects field teams, customers, and ERP in one AI-powered platform — giving your sales reps, drivers, technicians, and operators the right information at the right time to work smarter every day.",
    ...
    "faqs": [
      {
        ...
        "answer": "Yes. Users can continue working without an internet connection. Data automatically synchronizes with the ERP system once connectivity is restored."
      },
      {
        "question": "Can RepProX integrate with our ERP?",
        "answer": "Yes. RepProX is designed to integrate with SAP Business One, Odoo ERP, and other enterprise systems through secure APIs."
      },
      {
        "question": "Can the application be customized?",
        "answer": "Absolutely. RepProX is modular and highly configurable. Workflows, forms, approvals, reports, and business rules can all be tailored to your operational requirements."
      },
      {
        "question": "Which mobile platforms are supported?",
        "answer": "RepProX is available for Android and iOS devices, providing a consistent experience across smartphones and tablets."
      }
    ],
  ...
  },
  {
    "slug": "transsync",
    "title": "TransSync",
    "tagline": "Intelligent Intercompany Management Platform for SAP Business One",
    "cardFeatures": ["PO/SO Automate", "Master Data Sync", "Reconciliations", "SQL & HANA"],
    "conceptBullets": [
    ...
    "heroImage": "/images/products/transsync.png",
    ...
    "faqs": [
      {
        ...
        "answer": "TransSync is fully compatible with both SAP Business One SQL and SAP Business One HANA environments."
      },
      {
        "question": "Do we need custom coding to configure intercompany rules?",
        "answer": "No. TransSync includes an administration dashboard where business rules can be configured based on company, warehouse, branch, customer, or document type without writing code."
      },
      {
        "question": "Does it maintain independent accounting records?",
        "answer": "Yes. TransSync automates transactions and document creation between databases while respecting each entity's independent accounting records, chart of accounts, and financial compliance."
      },
      {
        "question": "How does it handle transaction errors?",
        "answer": "The platform includes a secure transaction monitor and error management dashboard. If a document synchronization fails due to validation, an alert is sent, and users can review, correct, and retry from the dashboard."
      }
    ],
    ...
    "ctaButtons": [
      {
        "label": "Schedule a Live Demonstration",
        "href": "/contact"
      },
      {
        "label": "Talk to a TransSync Specialist",
        "href": "/contact"
      }
    ]
  },
  {
    ...
    "cardFeatures": ["Freight Forwarding", "Warehouse Mobility", "Customs Clearance", "Job Costing"],
    "conceptBullets": [
    ...
    "heroImage": "/images/products/freight-puls.png",
    ...
    "faqs": [
      {
        ...
        "answer": "No, Freight Pulse is built to integrate natively with SAP Business One, allowing logistics, warehouse, and finance teams to work on a single database environment."
      },
      {
        "question": "Does it support international shipping?",
        "answer": "Yes. It supports Air Freight, Ocean Freight, Land Transportation, Cross-Trade, consolidation, and customs documentation requirements for global movements."
      },
      {
        "question": "How does the Customer Portal work?",
        "answer": "Customers receive secure login credentials where they can track active shipments, view milestones, download PDFs (like Bills of Lading, Invoices, BOE), and request quotes."
      },
      {
        "question": "How does it help with job costing?",
        "answer": "It connects all purchase invoices, shipping line bills, agent commissions, and customer invoices directly to a specific Shipment/Job ID, calculating exact profitability margins automatically."
      }
    ],
    ...
    "ctaButtons": [
      {
        "label": "Book a Live Demonstration",
        "href": "/contact"
      },
      {
        "label": "Speak with a Logistics Expert",
        "href": "/contact"
      }
    ]
  },
  {
    ...
    "cardFeatures": ["Transaction Alerts", "WhatsApp API", "SOA Distribution", "Crystal PDFs"],
    "conceptBullets": [
    ...
    "heroImage": "/images/products/engageflow.png",
    ...
    "faqs": [
      {
        ...
        "answer": "Yes. Organizations can automate communications through both channels using configurable business rules."
      },
      {
        "question": "Can communications be triggered automatically by SAP transactions?",
        "answer": "Absolutely. Messages can be generated automatically whenever selected SAP Business One documents are created, updated, or approved."
      },
      {
        "question": "Can we create marketing campaigns?",
        "answer": "Yes. EngageFlow includes campaign management capabilities for promotions, newsletters, customer announcements, seasonal offers, and more."
      },
      {
        "question": "Can templates be customized?",
        "answer": "Yes. Every email, WhatsApp message, and notification template can be fully branded and customized to match your organization's identity."
      }
    ],
    ...
    "ctaButtons": [
      ...
      {
        "label": "Talk to an EngageFlow Specialist",
        "href": "/contact"
      }
    ]
  },
  {
    ...
    "cardFeatures": ["XML Validation", "VAT Calculation", "Digital Signature", "Peppol Exchange"],
    "conceptBullets": [
    ...
    "heroImage": "/images/products/invoiceflow.png",
    ...
    "faqs": [
      {
        ...
        "answer": "No. While optimized for SAP Business One and Odoo ERP, InvoiceFlow is designed to integrate with other ERP and accounting systems through secure APIs."
      },
      {
        "question": "Can InvoiceFlow support both outbound and inbound electronic invoices?",
        "answer": "Yes. The platform supports issuing electronic invoices to customers as well as receiving and processing supplier invoices, depending on the regulatory framework and implementation scope."
      },
      {
        "question": "Will InvoiceFlow adapt to future UAE regulations?",
        "answer": "Yes. InvoiceFlow is designed with a modular architecture that allows updates as UAE e-invoicing regulations and technical standards evolve."
      },
      {
        "question": "Do you provide implementation and ongoing support?",
        "answer": "Absolutely. ALLE TECH offers readiness assessments, implementation, ERP integration, testing, training, go-live assistance, and long-term managed services."
      }
    ],
    ...
    "ctaButtons": [
      {
        "label": "Book an E-Invoicing Assessment",
        "href": "/contact"
      },
      {
